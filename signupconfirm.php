...
//     header('location:signupconfirm.php');
  ...
  {
      $con = mysqli_connect("localhost", "root", "", "oas");
      $rs  = mysqli_query($con,"select CONCAT('IES',LPAD(RIGHT(ifnull(max(s_id),'IES00000'),5) + 1,5,'0')) from t_user_data");
    ...
    <body style="background-image:url('./images/inbg.jpg');">
        <form id="signupconfirm" action="signupconfirm.php" method="post">
            ...
            <div class="container-fluid">    
               ...
               <div class="container"  >
                 <div class="row"style="margin-top: 20px;padding: 10px; text-align: justify-all;">
                  <div class="col-sm-4"></div>
                  <div class="col-sm-4"style="border: 2px solid grey; border-radius: 5%; "> 
                      <center><font style="color: #e91e63; margin-left:30px; font-family: Verdana;font-size:20px;">
                 ...
                 <center><input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary" style="width:100px;margin-top: 30px;"></center>
                  </div>
