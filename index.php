    ...
    <body  style="background-image:url('./images/inbg.jpg');" >
        <form id="index" action="index.php" method="post">
            ...
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/cutm.jpg" alt="Made By Team IES" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                </div>    
              <div class="row">
                <div style="float: right; margin-right: 13px">
                  <a href="adminlogin.php"><button type="button" class="btn btn-success">Administrator Login</button></a>
                </div>
              </div>
        
            
            
                <div class="abc" id="divtop">
                    
                        <br> <br> <br> <br>  <br> <br>
                            <div id="dmain"  > 
                               <center><img src="./images/loginuser.png" width="120px" height="100px" style=" border-radius: 50%"; ></center>
                                    <h3 class="text-center">Student Login Portal</h3>
                                    <p style="margin-left: 66px;">Enter User ID</p>
                                    ...
                                    <p style="margin-left: 66px;">Enter Password</p>
