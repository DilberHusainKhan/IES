     ...
     <body>
        <form id="adform" action="admsnform.php" method="post">
            ...
            <div id="dmid" class="container-fluid">  
                 ...
                 <div class="row">
                    <div class="col-sm-12">
                        <font style="color:green; margin-left:520px; font-family: Verdana; width:100%; font-size:30px;">
            ...
            <table class="frmtbl"style="background-image: url('./images/inbg.jpg');" >
                ...
                <tr>
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;"> Category</font></td>
                    <td colspan="4"><input type="radio" id="cat" name="cat" value="SC"><font style="font-family: Verdana;">SC</font>
                ...
                <tr>
                 ...
                 <!-- tr>
                    <td><font style="font-family: Verdana;">Category</font></td>
                    <td><select id="cat" name="cat" required="true">
                 ...
                 <tr>
                    <td><font style="font-family: Verdana;">Course</font></td>
